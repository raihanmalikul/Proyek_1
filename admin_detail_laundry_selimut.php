    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
      ...
      <div class="row mt-5 no-gutters">
        ...
        <div class="container">
          ...
          <h4 class=" text-center font-weight-bold pt-5">Detail Data Laundry Selimut</h4>
          <hr color="#0263A0">
          <br><br>
          <h5>Tabel selimut</h5>
          <hr>
...
<td>ID pesanan</td>
          ...
          <a href="menu_admin.php"><button class="btn btn-danger" >Kembali</button></a>
          <a href="ubah2.php?id=<?= $row["id_selimut"];?>"><button class="btn btn-success">Ubah</button></a>                
