  ...
  if( tambah($_POST) > 0 ) {
    ...
    echo "
          <script>
              ...
              document.location.href = 'laundry_pakaian.php';
          </script>";
  }
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
      ...
      <div class="row mt-5 no-gutters">
        ...
        <div class="col-md-10">
         <div class="container"> 
          <h4 class=" text-center font-weight-bold pt-5">Laundry Pakaian</h4>
          <hr color="#0263A0">
          <form action="laundry_pakaian.php" method="post" class="form">
          ...
          <div class="from-group pt-2">
            ...
            <div class="from-group pt-2">
                ...
                <input type="number" name="berat_pakaian" class="form-control" placeholder="Masukan berat pakaian (Kg)" value="<?=$_POST['berat_pakaian'];?>" required >
                <small id="emailHelp" class="form-text text-muted">catatan : Input Berat Pakaian pada laundry ini menggunakan sistem pembulatan kebawah untuk (1-1,5) kg menjadi 1 kg dan untuk (1,6-2) kg dibulatkan keatas menjadi 2 kg.</small>
            </div>
