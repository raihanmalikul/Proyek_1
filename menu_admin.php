  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
      ...
      <div class="row mt-5 no-gutters">
        ...
        <h4 class=" text-center font-weight-bold pt-5">Menu Data Pesanan Pelanggan</h4>
          <hr color="#0263A0">
          <h5>Tabel Pakaian</h5>
          <hr>
          ...
          <td><center><a href="admin_detail_laundry_pakaian.php?id=<?php echo $row["id_pakaian"];?>"><button class="btn btn-primary">details</button></a></center></td>
          ...
          <td><center><a href="admin_detail_laundry_selimut.php?id=<?php echo $rows["id_selimut"];?>"><button class="btn btn-primary">details</button></a></center></td>
          </tr>
          <?php $i++; ?>
          <?php endforeach; ?>
          </table>
